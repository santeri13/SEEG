...
func _ready():
	...
	emails.append("suto.kazuki@utcorp.com,Infromation about cargo,Can you send me information about your tracking numbers for today? I worked with one of them yesterday and it could be that I changed something there incorrectly.,malisiouse,Sure I work today with numbers JP0135 and UV2479. In attachment you cna find all information about record.")
...
func _hacked_message():
	read_mistakes()
	$Show_text.text = tr("Manager: We received from our team that someone accessed our server and downloaded the company's important data. By logs records were changed from your credentials. It is good that we have backups. Next time, pay close attention to what you do.\n Press enter to close")
	$Show_text.show()
	await pressedEnter
	await pressedEnter
	$Show_text.hide()

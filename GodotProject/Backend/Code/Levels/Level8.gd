...
func _ready():
	...
	emails.append("tech_guy@utcorpi.com,VPN access chnage,Can you change your VPN path to 110.0.0.1/24. This is a new path for new tools; our team needs to check if it works properly.,malisiouse,''")
...
func _companydata_send():
	...
	$Show_text.text = tr("Manager: We received from our team about a DDOS attack using the credentails of our workers.  Next time, pay close attention to what you do.\n Press enter to close")
	$Show_text.show()
	await pressedEnter
	await pressedEnter
	$Show_text.hide()

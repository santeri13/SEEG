...
func _prize_send():
	...
	$Show_text.text = tr("Bank: Hello! Someone tried to take a loan in your name using your data. Please do not provide your data to a suspisious person you do not know. \n Press eneter to close")
	$Show_text.show()
	await pressedEnter
	await pressedEnter
	$Show_text.hide()
